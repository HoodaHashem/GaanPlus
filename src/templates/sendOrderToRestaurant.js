const sendOrderToRestaurantData = (order) => {
  let itemsList = "";
  ...
  const emailHtml = `
    ...
    order.userId.lastName
        ...
        <p style="text-align: center;"><strong>Please prepare this order as soon as possible.</strong></p>
      </div>
    ...
    Login to your restaurant dashboard to confirm this order.
...
export default sendOrderToRestaurantData;
