const sendOrderCancelledData = (order) => {
  let itemsList = "";
    ...
    order.userId.lastName
      ...
      <div class="order-details">
        ...
        <table class="items-table">
          <tr>
            <th style="text
-align: left; padding: 8px; border-bottom: 2px solid #ddd;">Item</th>
      ...
      <p style="text-align: center;"><strong>Your order has been cancelled.</strong></p>
    </div>
    <div class="footer">
...
export default sendOrderCancelledData;
